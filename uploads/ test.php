...
?>
		...
		echo "<h2>Liste d'adresse</h2>";

		$links = array("www.abelmbula.fr", "www.jean.fr", "www.fsf.fr", "www.angel.com", "www.unikis.fr");
		#srand(time());
		shuffle($links);
		$site=$links[0];

		#print_r($links);
		echo "Voici le site en question <a href='$links[0]'>$links[0]</a>";
		?>
